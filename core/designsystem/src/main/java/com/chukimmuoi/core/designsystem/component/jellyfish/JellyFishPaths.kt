...
object JellyFishPaths {
    ...
    val leftEye = PathParser().parsePathString(
        "M262 233.63a3.1 3.1 0 1 0-3 3.19 3.1 3.1 0 0 0 3-3.19z"
    ).toNodes()
    val rightEye = PathParser().parsePathString(
        "M294 232.72a3.1 3.1 0 1 0-3 3.18 3.1 3.1 0 0 0 3-3.18z"
    ).toNodes()
    ...
    val outerJelly = PathParser().parsePathString(
    ...
    val tentacle2 = PathParser().parsePathString(
    ...
    val tentacle3 = PathParser().parsePathString(
    ...
    val tentacle4 = PathParser().parsePathString(
    ...
    val tentacle5 = PathParser().parsePathString(
    ...
    val tentacle6 = PathParser().parsePathString(
    ...
    val tentacle7 = PathParser().parsePathString(
    ...
    val tentacle8 = PathParser().parsePathString(
    ...
    val tentacle9 = PathParser().parsePathString(
