package com.chukimmuoi.core.designsystem.component.menu
...
import com.chukimmuoi.core.designsystem.component.button.StockOutlinedButton
 ...
 * @Project: StockVN
 * Created by chukimmuoi on 30/11/2022.
 */
/**
 * Stock dropdown menu button with included trailing icon as well as text label and item
 * content slots.
 *
...
fun <T> StockDropdownMenuButton(
    ...
    Box(modifier = modifier) {
        StockOutlinedButton(
            ...
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) StockIcons.ArrowDropUp else StockIcons.ArrowDropDown,
...
/**
 * Stock dropdown menu with item content slots. Wraps Material 3 [DropdownMenu] and
 * [DropdownMenuItem].
 *
