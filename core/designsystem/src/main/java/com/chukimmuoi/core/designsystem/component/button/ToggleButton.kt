 ...
 */
/**
 * Stock toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
...
fun StockToggleButton(
    ...
    size: Dp = StockToggleButtonDefaults.ToggleButtonSize,
    iconSize: Dp = StockToggleButtonDefaults.ToggleButtonIconSize,
...
/**
 * Stock toggle button default values.
 */
object StockToggleButtonDefaults {
